...
export default function Navbar() {
  return (
    <div className="flex fixed z-50 bg-white text-xl bg-opacity-5 backdrop-blur-md font-poppins font-semibold flex-row w-full px-6 py-4 justify-between items-center">
